...
public class FragmentWelcomeBindingImpl extends FragmentWelcomeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.imageViewRobotimy, 2);
        sViewsWithIds.put(R.id.textViewNameApp, 3);
        sViewsWithIds.put(R.id.action_to_controllers, 4);
        sViewsWithIds.put(R.id.action_to_bluetooth, 5);
    }
    // views
    @NonNull
