...
public abstract class FragmentWelcomeBinding extends ViewDataBinding {
  @NonNull
  public final FloatingActionButton actionToBluetooth;

  @NonNull
  public final FloatingActionButton actionToControllers;

  @NonNull
  public final ImageView imageViewRobotimy;
  ...
  protected FragmentWelcomeBinding(Object _bindingComponent, View _root, int _localFieldCount,
      FloatingActionButton actionToBluetooth, FloatingActionButton actionToControllers,
      ImageView imageViewRobotimy, TextView textViewNameApp, TextView textViewTitle) {
    super(_bindingComponent, _root, _localFieldCount);
    this.actionToBluetooth = actionToBluetooth;
    this.actionToControllers = actionToControllers;
    this.imageViewRobotimy = imageViewRobotimy;
